...
export const firebaseConfig = {
  ...
  apiKey: 'AIzaSyCTyyZ5S1fQipxBfiqp7-oi5e8-_XMBcSw',
  authDomain: 'skillmap-62b2a.firebaseapp.com',
  databaseURL: 'https://skillmap-62b2a.firebaseio.com',
  projectId: 'skillmap-62b2a',
  storageBucket: 'skillmap-62b2a.appspot.com',
  messagingSenderId: '464596395348'
};
